...
##  Prerequisite course requirements {#13.1-prerequisite-course-requirements}
...
- [ ] This is a sample citation to Knuth's work [@knuth84].
- [ ] the above dummy has been created so that atleast one reference exists
